...
//		apiToast('onConnect', 2000);
		console.log("connected");
		var topic = $('#devidtopic').val();
		//      var topic = "d64f517c/aca213caec5c/#";
		websocketclient.subscribe(topic, 0, "#3f8a5d");
...
//		apiToast('connectOnFail', 2000);
	...
	'unsubscribe' : function(id) {
		var subs = _.find(websocketclient.subscriptions, {
			'id' : id
		});
